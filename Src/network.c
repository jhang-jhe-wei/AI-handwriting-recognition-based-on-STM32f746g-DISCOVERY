...
#define AI_TOOLS_DATE_TIME   "Mon Dec  2 11:06:46 2019"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 64, 10, 1, 1), AI_STRIDE_INIT(4, 4, 256, 2560, 2560),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 784, 64, 1, 1), AI_STRIDE_INIT(4, 4, 3136, 200704, 200704),
